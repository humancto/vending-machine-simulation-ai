...
pytest -q tests/test_race_config.py tests/test_race_preflight.py tests/test_race_local_mode.py tests/test_race_server_mode.py tests/test_race_scenario_io.py
```
